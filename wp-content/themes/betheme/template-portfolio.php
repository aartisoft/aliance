...
<div id="Content">
	<div class="content_wrapper clearfix">
		...
		<div class="section mcb-section" id="quem-somos" style="padding-top:0px; padding-bottom:0px; background-color:#ffffff; background-image:url(http://localhost/wp-content/uploads/2018/09/bg-title.png); background-repeat:no-repeat; background-position:right center; background-attachment:; background-size:; -webkit-background-size:" data-id="#quem-somos">
